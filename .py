...
# TEAM 1 = AI-A + AI-B
#
# This is the actual 2-vs-1 structure.
# ============================================================
...
# ============================================================
#
# AI-A and AI-B do not merely share a target.
#
# They share:
#   - predicted target motion
#   - geometric formation
#   - temporary roles
#   - recent joint transformations
#
# This is NOT reward learning.
# There is no score for "good teamwork".
#
# The memory describes what the TEAM changed into.
#
# ============================================================
...
class TeamCoordinationMemory:
    ...
    def __init__(self):
        ...
        # Each AI contributes one prediction.
        # The shared prediction is the fusion of those
        # observations, not a single-agent overwrite.
        self.predictions = {}
    ...
    def update_prediction(
        ...
        # Two-agent agreement is more informative than
        # one-agent prediction, but never becomes a reward.
        agreement = 0.0
    ...
    def update(
        ...
        if len(allies) >= 2:
            ...
            # Extra teammates, if added later.
    ...
    def formation_vector(
        ...
        # Perpendicular direction around the target.
        tangent_x = -ny
        tangent_y = nx

        # ----------------------------------------------------
        # PRESSURE:
        # move toward the target, but avoid stacking
        # directly on top of the ally.
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # FLANK:
        # move toward a point offset from the target.
        #
        # The sign is determined by which side of the
        # target the ally occupies.
        # ----------------------------------------------------
        ...
        # Pull the flanker toward a useful distance.
...
class TransformationAI:
    ...
    def observe_all(
        ...
        # ----------------------------------------------------
        # IMPORTANT:
        # Only observe ENEMIES as opponents.
        #
        # AI-A does NOT treat AI-B as an opponent.
        # AI-B does NOT treat AI-A as an opponent.
        # ----------------------------------------------------
        ...
        # both AI agents converge on the same enemy target.
    ...
    def choose(
        ...
        # ----------------------------------------------------
        # Only enemies from the opposing team.
        # ----------------------------------------------------
...
class World:
    ...
    def __init__(self):
        ...
        # Shared team knowledge for AI-A + AI-B.
        self.team_memory = (
...
class Fighter:
    ...
    def target(
        ...
        # AI teammates share a common target.
        # If one exists in the shared team memory,
        # prefer it over independently switching targets.
        shared_id = getattr(
    ...
    def control_ai(
        ...
        # ----------------------------------------------------
        # TEAM EVOLUTION:
        # AI-A and AI-B use different geometric roles.
        #
        # PRESSURE -> attacks the front.
        # FLANK    -> attacks from the side.
        #
        # This is coordination from predicted change,
        # not a reward signal.
        # ----------------------------------------------------
        ...
        # FORMATION FORCE
        #
        # The shared team brain changes only geometry.
        # It does not provide a reward.
        # ----------------------------------------------------
    ...
    def damage(
        ...
        # ----------------------------------------------------
        # SAFETY:
        # Friendly fire is completely disabled.
        # ----------------------------------------------------
...
screen.title(
    "LAW OF CHANGE : 2 VS 1 TINY CURIOSITY"
)
...
def update_bullets():
    ...
    for b in bullets:
        ...
        for f in fighters:
            ...
            # FRIENDLY FIRE OFF
            #
            # AI-A bullet cannot hit AI-B.
            # AI-B bullet cannot hit AI-A.
            # ------------------------------------------------
